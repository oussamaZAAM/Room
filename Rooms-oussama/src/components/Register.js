...
export default function Register() {
    ...
    const userRegister= async (e)=>{
        ...
        if(password.current.value==rePassword.current.value){
            const user = {username:username.current.value, email:email.current.value,password:password.current.value, picture:"../images/profile.png", cover:"../images/cover.png"}
            try{
